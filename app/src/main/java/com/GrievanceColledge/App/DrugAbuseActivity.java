...
public class DrugAbuseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drug_abuse);
        ...
        SubmitSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.isEmpty()){
                    Toast.makeText(DrugAbuseActivity.this,"Pleas fill the password field",Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText(DrugAbuseActivity.this,"Pleas fill the Contact field",Toast.LENGTH_SHORT).show();
                }

                else if (comment.isEmpty()){
                    Toast.makeText(DrugAbuseActivity.this,"Pleas fill the Comment field",Toast.LENGTH_SHORT).show();
                }
                    ...
                    Toast.makeText(DrugAbuseActivity.this,"User Info \n:"+Colector,Toast.LENGTH_SHORT).show();
                }
        ...
        categoryCountry.add("Select Department");
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
                if(parent.getItemAtPosition(position).equals("Select Country")){
                    ...
                    Colector+=item+"\n";
                    Toast.makeText(DrugAbuseActivity.this, "Selected Country: "+item, Toast.LENGTH_SHORT).show();
                }
            }
